...
#define maxBObj 5000
#define maxbEndT 100 //millseconds
...
int main( )
{
	...
	cout<<pl<<" BTO List Lock Free Decentralized Algorithm\n"<<pl;
	int totalRun = 6;
...
//		cout<<"\nAvg Grpah Time= "<<gConstT/nThread<<" microseconds";
		...
		if(numItr > 0)//skip first run
		file_opr.writeOpt(nBidder, nThread, numAUs, totalT, mTTime, vTTime, aCount, vAUs, mItrT, vItrT);
//		cout<<"\n===================== Execution "
//			<<numItr+1<<" Over =====================\n"<<endl;
//		cout<<"\n";
		listAUs.clear();
